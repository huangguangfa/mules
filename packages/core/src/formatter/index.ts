...
export default class Formatter {
   ...
   */
     ...
     */
    static number(num: number, precision = 2) {
     ...
     * @returns {String} 格式化后的字符串
     */
    static price(num: number, precision = 2) {
     ...
     * @returns {String} 转化后的字符串
     */
    static uncamel(str: string, sep:string = '_', textcase: string = ''): string {
        const result:any = str.replace(/([a-z\d])([A-Z])/g, '$1' + sep + '$2')
