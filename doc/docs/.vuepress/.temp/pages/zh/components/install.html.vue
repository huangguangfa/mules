<template><div><Toc></Toc><div class="custom-container tip"><p class="custom-container-title">介绍</p>
<p><code v-pre>gf-ui</code>是一款基于<code v-pre>h5 component</code>开发的的web组件库、用于快速构建pc网站中后台产品! <code v-pre>作者</code>在不同项目所尝试了很多UI库、也挖掘了很多组件库的优缺点在把一些好的优的用于在此, 作者一般在晚上进行迭代、或者平常节假日, 如有问题联系:1454556135@qq.com</p>
</div>
<Toc></Toc><h4 id="特性" tabindex="-1"><a class="header-anchor" href="#特性" aria-hidden="true">#</a> 特性</h4>
<ul>
<li>基于h5新组件方式开发</li>
<li>支持<code v-pre>市面主流框架</code>的集成使用、也可以通过cdn方式在传统html里面去使用</li>
<li>提供友好的API, 灵活的组件使用</li>
