...
<li><code v-pre>参数</code>
<ul>
<li><code v-pre>options:{ cryptoType:{ name:string }, storageType: session | local }</code></li>
<li><code v-pre>options[cryptoType] = { name:&quot;none&quot; }</code> 加密类型（默认：不加密, <span class="colorff0066 font-bold">加密仅限于  AES、DES、RC4</span>）</li>
<li><code v-pre>options[storageType] = { storageType: local | session }</code> 存储位置（默认：session）</li>
</ul>
</li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div><h3 id="get" tabindex="-1"><a class="header-anchor" href="#get" aria-hidden="true">#</a> <code v-pre>get</code></h3>
<ul>
<li>设置指定key和value到会话储存实例中</li>
<li><code v-pre>参数</code>
<ul>
<li><code v-pre>options:{ cryptoType:{ name:string }, storageType: session | local }</code></li>
<li><code v-pre>options[cryptoType] = { name:&quot;none&quot; }</code> 加密类型（默认：不加密, <span class="colorff0066 font-bold">加密仅限于  AES、DES、RC4</span>）</li>
<li><code v-pre>options[storageType] = { storageType:&quot;session&quot; }</code> 存储位置（默认：session）</li>
</ul>
</li>
</ul>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> keys <span class="token operator">=</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br></div></div><h3 id="remove" tabindex="-1"><a class="header-anchor" href="#remove" aria-hidden="true">#</a> <code v-pre>remove</code></h3>
<ul>
<li>删除<code v-pre>本地缓存</code>或<code v-pre>会话缓存</code>指定的key  <code v-pre>storageType默认：session</code></li>
<li><code v-pre>参数</code>
<ul>
<li><code v-pre>(key:string, storageType:local | session) =&gt; void</code></li>
</ul>
</li>
</ul>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> keys <span class="token operator">=</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><h3 id="contains" tabindex="-1"><a class="header-anchor" href="#contains" aria-hidden="true">#</a> <code v-pre>contains</code></h3>
<ul>
<li>获取<code v-pre>本地缓存</code>或<code v-pre>会话缓存</code>中是否包含指定key的实例 <code v-pre>storageType 默认：session</code></li>
<li><code v-pre>参数</code>
<ul>
<li><code v-pre>(key:string, storageType:local | session) =&gt; boolean</code></li>
</ul>
</li>
</ul>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> keys <span class="token operator">=</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><h3 id="clear" tabindex="-1"><a class="header-anchor" href="#clear" aria-hidden="true">#</a> <code v-pre>clear</code></h3>
<ul>
<li>清除<code v-pre>本地缓存</code>或<code v-pre>会话缓存</code>位置所有内容 <code v-pre>storageType 默认：session</code></li>
<li><code v-pre>参数</code>
<ul>
<li><code v-pre>(storageType:local | session) =&gt; number</code></li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><h3 id="clearall" tabindex="-1"><a class="header-anchor" href="#clearall" aria-hidden="true">#</a> <code v-pre>clearAll</code></h3>
<ul>
